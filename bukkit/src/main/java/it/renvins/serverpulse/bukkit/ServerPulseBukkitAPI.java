...
public class ServerPulseBukkitAPI implements ServerPulseAPI {
    ...
    public ServerPulseBukkitAPI(IDatabaseService databaseService, IMetricsService metricsService, ITPSRetriever tpsRetriever,
